...
public class KDBCassandra extends KDataBase {

	public KDBCassandra(String host, String user, String pass, String base, String port) {
	...
	public KDBCassandra(String host, String user, String pass, String base) {
	...
	public String getURL(KDbParams params) {
		String u = "jdbc:cassandra:" + params.getHost() + ":" + params.getBase();
		if (!params.getPort().equals(""))
			u = "jdbc:cassandra:" + params.getHost() + ":" + params.getPort() + ":" + params.getBase();
